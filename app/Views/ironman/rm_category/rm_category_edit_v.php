    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <i class="fal fa-layer-plus">&nbsp;</i> Category Edit
                    </h2>
                </div>
                <!-- *****Filter Start****** -->
                <div class="panel-container show">
                    <div class="panel-content">
                        <!-- <div class="panel-tag"> -->
                        <form class="was-validated" method="post" enctype="multipart/form-data" action="<?= base_url("/ironman/Rm_category_c/update_category") ?>" autocomplete="off">
                            <div class="panel-content">
                                <!-- ------Div start-------- -->
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm flex-nowrap">
                                                ...
                                                <select class="custom-select form-control is-invalid" name="rm_category_chain_parent" id="customControlValidation5" required>
                                                    <!-- <option value="<?//php echo $category->rm_category_id; ?>"><?//php echo $category->rm_category_chain_parent; ?></option> -->
                                                    <option value="<?php echo $category->rm_category_id; ?>">
                                                        <?php $cat_arr = explode(",", $category->rm_category_chain_parent);
                                            ...
                                            <div class="help-block">Select your category.</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
