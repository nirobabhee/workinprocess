        ...
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div id="panel-2" class="panel" data-panel-fullscreen data-panel-close data-panel-collapsed data-panel-locked data-panel-reset data-panel-color data-panel-custombutton data-refresh-timer="3000">
                    <div class="panel-hdr">
                        <h2>
                            <i class="fal fa-filter"></i>&nbsp; Filter Portion
                        </h2>
                    </div>
                    <!-- *****Filter Start****** -->
                                ...
                                <form method="POST" action="" autocomplete="off">
                                    <div class="panel-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="addon-wrapping-left">Input</label>
                                                    <div class="input-group input-group-sm flex-nowrap">
                                                        <input type="text" class="form-control" name="menu_name" placeholder="Enter Menu Name" aria-describedby="input-group-sm-size" aria-label="Menuname" data-template='<div class="tooltip" role="tooltip"><div class="tooltip-inner small fw-400"></div></div>' data-toggle="tooltip" data-original-title="Enter Your Text">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="addon-wrapping-left">Dropdown/Select</label>
                                                    <div class="input-group input-group-sm flex-nowrap">
                                                        <select class="select2-placeholder form-control" name="parent_menu" data-template='<div class="tooltip" role="tooltip"><div class="tooltip-inner small fw-400"></div></div>' data-toggle="tooltip" data-original-title="Select Your desire item.">
                                                            <option>Sample Deya</option>
                                                            <option>Administrator</option>
                                                            <option>Sales Person</option>
                                                            <option>Incharge + Sales Person</option>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="addon-wrapping-left">Number</label>
                                                    <div class="input-group input-group-sm flex-nowrap">
                                                        <input type="number" class="form-control" name="password" placeholder="Sorting Your Menu" aria-label="password" aria-describedby="addon-wrapping-left" data-template='<div class="tooltip" role="tooltip"><div class="tooltip-inner small fw-400"></div></div>' data-toggle="tooltip" data-original-title="Enter Your Numbers.">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="addon-wrapping-left">Start date</label>
                                                    <div class="input-group input-group-sm flex-nowrap">
                                                        <input type="text" class="form-control " id="custom-range" placeholder="End Date" id="datepicker_end" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="addon-wrapping-left">End date:</label>
                                                    <div class="input-group input-group-sm flex-nowrap">
                                                        <input type="text" class="form-control " placeholder="End Date" id="datepicker_end" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        <div class="input-daterange input-group input-group-sm" id="dateRangePicker">
                                                            <input type="text" class="form-control" name="start_date" placeholder="Start Date" readonly>
                                                            <div class="input-group-append input-group-prepend">
                                                                <span class="input-group-text fs-xl"><i class="fal fa-glasses-alt"></i></span>
                                                            </div>
                                                            <input type="text" class="form-control" name="end_date" placeholder="End Date" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="multiselect4">Multiple & Select2</label>
                                                    <div class="input-group input-group-sm flex-nowrap">
                                                        <select class="select2-placeholder-multiple form-control " multiple="multiple" id="multiple_mobile_menu">
                                                            <optgroup label="You are allow to Multiple Select.">
                                                    ...
                                                    <div class="input-group-sm flex-nowrap">
                                                        <div class="frame-wrap">
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" class="custom-control-input" id="statusRadio4" name="menu_status" checked="">
                                                                <label class="custom-control-label" for="statusRadio4">Active</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" class="custom-control-input" id="unstatusRadio4" name="menu_status">
                                                                <label class="custom-control-label" for="unstatusRadio4">Inactive</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group my-5 input-group-sm">
                                                    <button type="button" name="submit_user" class="btn  btn-sm btn-pills  btn-outline-primary btn-block "><i class="fal fa-search"> Filter</i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- -------Div End--------- -->
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <!-- datatable start -->
                        <table id="dt_scoller" class="table table-sm table-bordered table-hover table-striped w-100">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th>Particulars</th>
                                    <th>Product Qty</th>
                                    <th>Approved Material Qty</th>
                                    <th>Approved Material price</th>
                                    <th>BOM Total</th>
                                    <th>Variance</th>
                                    <th>Worker</th>
                                    <th>Timezone</th>
