...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700">2012-<?php echo date('Y'); ?>&nbsp; © &nbsp; <a
                href='https://www.ictlayer.com/' class='text-primary fw-500' title='https://www.ictlayer.com/'
                target='_blank'>ICTLayer</a></span>
    </div>
    <div>
...
<nav class="shortcut-menu d-none d-sm-block">
    ...
    <a href="<?= base_url('/ironman/logout_c'); ?>" class="menu-item btn" data-toggle="tooltip" data-placement="left"
        title="Logout">
        ...
        <div class="modal-content h-100">
                ...
                <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                    <span class="mr-2">
                        <!-- <span class="rounded-circle profile-image d-block"
                            style="background-image:url('user_imag/avatar-d.png'); background-size: cover;"></span> -->
                        <img class="rounded-circle profile-image d-block"
                            src="<?php echo base_url() . '/user_img/user.png'; ?>" style="background-size: cover;" />
                    </span>
                    <div class="info-card-text">
                        <a href="javascript:void(0);" class="fs-lg text-truncate text-truncate-lg text-white"
                            data-toggle="dropdown" aria-expanded="false">
                            <?php if (isset($_SESSION['login_user'])) {
                                echo $_SESSION['login_user']->user_full_name;
                            } ?>
                        ...
                        <span class="text-truncate text-truncate-md opacity-80"><?php if (isset($_SESSION['login_user'])) {
                                                                                    echo $_SESSION['login_user']->user_group;
                                                                                } ?></span>
                    </div>
                </div>
            ...
            <div class="modal-body p-0 h-100 d-flex">
                ...
                <div
                    ...
                    <div class="flex-1 h-100 custom-scroll user_list_div">
                        <div class="w-100">
                            <ul id="js-msgr-listfilter" class="list-unstyled m-0">
                                <?php
                                if (isset($_SESSION['get_all_active_user'])) {
                                    foreach ($_SESSION['get_all_active_user'] as $active_user) { ?>
                                <li id="<?php echo $active_user->user_id; ?>">
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                <?php echo $active_user->user_full_name; ?>
                    ...
                    <form>
                        <div class="d-flex flex-column">
                            ...
                            <div class="height-8 px-3 d-flex flex-row align-items-center flex-wrap flex-shrink-0">
                                ...
                                <div class="ml-auto">
                                    <a id="send_message" href="javascript:void(0);" class="btn btn-info">Send</a>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <ul class="m-0">
                            ...
                            <li>
                                <a href="#" id="myapp-1" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-1.css"
                            ...
                            <li>
                                <a href="#" id="myapp-2" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-2.css"
                            ...
                            <li>
                                <a href="#" id="myapp-3" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-3.css"
                            ...
                            <li>
                                <a href="#" id="myapp-4" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-4.css"
                            ...
                            <li>
                                <a href="#" id="myapp-5" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-5.css"
                            ...
                            <li>
                                <a href="#" id="myapp-6" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-6.css"
                            ...
                            <li>
                                <a href="#" id="myapp-7" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-7.css"
                            ...
                            <li>
                                <a href="#" id="myapp-8" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-8.css"
                            ...
                            <li>
                                <a href="#" id="myapp-9" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-9.css"
                            ...
                            <li>
                                <a href="#" id="myapp-10" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-10.css"
                            ...
                            <li>
                                <a href="#" id="myapp-11" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-11.css"
                            ...
                            <li>
                                <a href="#" id="myapp-12" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-12.css"
                            ...
                            <li>
                                <a href="#" id="myapp-13" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-13.css"
                            ...
                            <li>
                                <a href="#" id="myapp-14" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-14.css"
                            ...
                            <li>
                                <a href="#" id="myapp-15" data-action="theme-update" data-themesave
                                    data-theme="<?= base_url() ?>/assets/css/themes/cust-theme-15.css"
...
$(document).ready(function() {
    $(function() {
        ...
        function icon(elm) {
            elm.element;
            return elm.id ? "<i class='" + $(elm.element).data("icon") + " mr-2'></i>" + elm.text : elm
                .text
        }
...
var others_id;
$(document).ready(function() {
    $(".user_list_div li").click(function() {
        others_id = $(this).attr('id');
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('ironman/Chat_messenger_c/get_messages_by_id'); ?>',
            data: {
                others_id: others_id
            },
            success: function(response) {
                if (response) {
                    ...
                    console.log('Check This Issue Please !');
                }
            }
        });
        setInterval(function() {
            fetch_data(others_id);
        }, 3000);
    });
    $('#send_message').click(function() {
        var msg = $('#msgr_input').text();
        //var form_data = new FormData();
        //form_data.append("file-input", document.getElementById('file-input').files[0]);
        //var img = document.getElementById('file-input').files[0];
        //var f = document.getElementById("file-input").files[0];
        //var fsize = f.size || f.fileSize;
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('ironman/Chat_messenger_c/insert_messages_by_id'); ?>',
            //processData: false,
            //contentType: false,
            data: {
                //form_data: form_data,
            ...
            success: function(response) {
                if (response == 'Yes') {
                    ...
                    console.log('No Data got inserted !');
                }
            }
        });
    });

    function fetch_data(others_id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('ironman/Chat_messenger_c/get_messages_by_id'); ?>',
            data: {
