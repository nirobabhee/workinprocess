...
<body>
	...
	<header>
		...
		?>
			...
			<a href="<?= base_url("/ironman/dashboard_c"); ?>">Dashboard</a><br>
			<a href="<?= base_url("/ironman/user_c"); ?>">User</a><br>
			<a href="<?= base_url("/ironman/menu_setting_c"); ?>">Menu</a><br>
			<a href="<?= base_url("/ironman/product_c"); ?>">Product Page</a><br>
			<a href="<?= base_url("/ironman/datatable_ex"); ?>">DataTable & Filter</a><br>
			<a href="<?= base_url("/ironman/datatable_ex/scroller"); ?>">DataTable & Scroller</a><br>
			<a href="<?= base_url("/ironman/datatable_ex/report"); ?>">DataTable & Report</a><br>
			<a href="<?= base_url("/"); ?>">Login</a><br>
			<a href="<?= base_url("/ironman/setting_backend_c"); ?>">Backend Setting</a><br>
			<a href="<?= base_url("/ironman/rm_c"); ?>">RM</a><br>
			<a href="<?= base_url("/ironman/rm_category_c"); ?>">RM Category</a><br>
			<a href="<?= base_url("/ironman/fg_category_c"); ?>">FG Category</a><br>
			<a href="<?= base_url("/ironman/section_c"); ?>">Section</a><br>
			<a href="<?= base_url("/ironman/rm_godown_c"); ?>">RM Godown</a><br>
			<a href="<?= base_url("/ironman/fg_godown_c"); ?>">FG Godown</a><br>
			<a href="<?= base_url("/ironman/bom_c"); ?>">Bom </a><br>
			<a href="<?= base_url("/ironman/lineup_c"); ?>">lineup </a><br>


			<img src="<?= base_url() ?>/user_img/sample_image.jpg" alt="" height="200" width="200">
